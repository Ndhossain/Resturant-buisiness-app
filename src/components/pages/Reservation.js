        ...
        <div className={classes.mainReservation}>
          <ul className={classes.reservationMenu}>
            <li
              onClick={handleClick}
              className={
                menuActivation === "Custom Reservation" ? classes.active : null
              }
            >
              Custom Reservation
            </li>
            <li
              onClick={handleClick}
              className={
                menuActivation === "Launch Reservation" ? classes.active : null
              }
            >
              Launch Reservation
            </li>
            <li
              onClick={handleClick}
              className={
                menuActivation === "Dinner Reservation" ? classes.active : null
              }
            >
              Dinner Reservation
            </li>
